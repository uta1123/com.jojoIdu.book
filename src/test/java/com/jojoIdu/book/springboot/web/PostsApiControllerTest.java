...
//@WebMvcTest 사용하면 JPA기능이 작동하지 않고 Controller, ControllerAdviser 등 외부 연동에 관련된
// 부분만 활성화 되니 @SpringBootTest와 TestRestTemplate를 사용하면 된다.
...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        System.out.println("all.get(0).getTitle()) : "+ all.get(0).getTitle());
